...
namespace WebServerTests.ListenersTests
{
    ...
    {
        [Fact]
        public void Ctor_Should_Create_Instance_When_ServerOptions_Valid()
        {
            // Arrange
        ...
        [Fact]
        public void Ctor_Should_Throw_When_ServerOptions_IpAddress_Invalid()
        {
            // Arrange
            var options = new ServerOptions()
            {
        ...
        [Fact]
        public void Ctor_Should_Throw_When_ServerOptions_Port_Invalid()
        {
            // Arrange
            var options = new ServerOptions()
            {
        ...
        [Fact]
        public void Ctor_Should_Throw_When_ServerOptions_Null()
        {
            // Arrange & Act
